						...
						<div class="row g-2">
							...
							<div class="col-sm-5 mx-auto">
								...
								<div class="form-check">
									<input id="5" name="rad_but" value="5 Звёзд" type="radio" class="form-check-input" required>
									<label class="form-check-label">Отлично</label>
								</div>
								<div class="form-check">
									<input id="4" name="rad_but" value="4 Звезды" type="radio" class="form-check-input" required>
									<label class="form-check-label">Хорошо</label>
								</div>
								<div class="form-check">
									<input id="3" name="rad_but" value="3 Звезды" type="radio" class="form-check-input" checked required>
									<label class="form-check-label">Нормально</label>
								</div>
								<div class="form-check">
									<input id="2" name="rad_but" value="2 Звезды" type="radio" class="form-check-input" required>
									<label class="form-check-label">Плохо</label>
								</div>
								<div class="form-check position-relative">
									<input id="1" name="rad_but" value="1 Звезда" type="radio" class="form-check-input" required=>
