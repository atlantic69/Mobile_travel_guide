...
<?php
	...
	$mysql->query("INSERT INTO `dost` (`title`, `address`, `coorX`, `coorY`, `country`, `state`, `description`, `author`, `photo`)
	VALUES ('$title', '$address', '$coorX',  '$coorY', '$country', '$state', '$description', '$author', '$photo')");
	$mysql->close();
