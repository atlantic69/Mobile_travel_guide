...
<html lang="ru">
	...
	<div class = "block">
		...
		<div class="container px-5">
			<div class="container p-4 rounded-6 bg-dark text-white shadow" style="--bs-bg-opacity: .85;">
   			...
   			<form>
					<div class="row g-2">
						...
						<div class="col-sm-5 mx-auto">
							<h6 class="form-label">Координата X:</h6>
							<input type="text" class="form-control" name="coorX" value="<?php echo $coorX ?>">
						</div>
						<div class="col-sm-5 mx-auto">
							<h6 class="form-label">Координата Y:</h6>
							<input type="text" class="form-control" name="coorY" value="<?php echo $coorY ?>">
						</div>
						<div class="col-11 mx-auto">
